...
public class ICDGEMAdminUtils {
    ...
    public static void displayExporterStatus(Exporter exporter) {
        ...
        do {
            ...
            if (s != null && !s.equals(msg)) {
            	ICDGEMAdminUtils.displayTaggedMessage(s);
                msg = s;
            }
    ...
    public static void displayLoaderStatus(Loader loader) {
        ...
        do {
            ...
            if (num != cnum) {
            	ICDGEMAdminUtils.displayTaggedMessage("# concepts processed: " + num);
                cnum = num;
            }
            num = status.getNumRelationsLoaded();
            if (num != rnum) {
            	ICDGEMAdminUtils.displayTaggedMessage("# relations processed: " + num);
                rnum = num;
            }
            String s = status.getMessage();
            if (s != null && !s.equals(msg)) {
