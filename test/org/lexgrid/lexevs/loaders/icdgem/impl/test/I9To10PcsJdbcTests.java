...
public class I9To10PcsJdbcTests  extends TestCase {
	
	public I9To10PcsJdbcTests(String serverName) {
		super(serverName);
	}
	
	public void testSelectFromEntityI9To10Pcs() {
		ICDGEMTestJdbcSelectFromEntityDO helper = ICDGEMTestJdbcSelectFromEntityDO.createObj(ICDGEMTestJdbcSelectFromEntityDO.I9_10_PCS);
	...
	public void testSelectFromEntryStateI9To10Pcs() {
		ICDGEMTestJdbcSelectFromEntryStateDO helper = ICDGEMTestJdbcSelectFromEntryStateDO.createObj(ICDGEMTestJdbcSelectFromEntryStateDO.I9_10_PCS);
	...
	public void testSelectFromEntityAssnsToEntityI9To10Pcs() {
		ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO helper = ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO.createObj(ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO.I9_10_PCS);
