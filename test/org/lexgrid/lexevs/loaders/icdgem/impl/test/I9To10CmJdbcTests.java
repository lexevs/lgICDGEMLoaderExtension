...
public class I9To10CmJdbcTests  extends TestCase {
	
	public I9To10CmJdbcTests(String serverName) {
		super(serverName);
	}
	
	public void testSelectFromEntityI9To10Cm() {
		ICDGEMTestJdbcSelectFromEntityDO helper = ICDGEMTestJdbcSelectFromEntityDO.createObj(ICDGEMTestJdbcSelectFromEntityDO.I9_10_CM);
	...
	public void testSelectFromEntryStateI9To10Cm() {
		ICDGEMTestJdbcSelectFromEntryStateDO helper = ICDGEMTestJdbcSelectFromEntryStateDO.createObj(ICDGEMTestJdbcSelectFromEntryStateDO.I9_10_CM);
	...
	public void testSelectFromEntityAssnsToEntityI9To10Cm() {
		ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO helper = ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO.createObj(ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO.I9_10_CM);
