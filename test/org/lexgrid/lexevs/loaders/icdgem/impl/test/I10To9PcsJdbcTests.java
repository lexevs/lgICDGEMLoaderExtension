...
public class I10To9PcsJdbcTests  extends TestCase {
	
	public I10To9PcsJdbcTests(String serverName) {
		super(serverName);
	}
	
	public void testSelectFromEntityI10To9Pcs() {
		ICDGEMTestJdbcSelectFromEntityDO helper = ICDGEMTestJdbcSelectFromEntityDO.createObj(ICDGEMTestJdbcSelectFromEntityDO.I10_9_PCS);
	...
	public void testSelectFromEntryStateI10To9Pcs() {
		ICDGEMTestJdbcSelectFromEntryStateDO helper = ICDGEMTestJdbcSelectFromEntryStateDO.createObj(ICDGEMTestJdbcSelectFromEntryStateDO.I10_9_PCS);
	...
	public void testSelectFromEntityAssnsToEntityI10To9Pcs() {
		ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO helper = ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO.createObj(ICDGEMTestJdbcSelectFromEntityAssnsToEntityDO.I10_9_PCS);
